            ...
            <div className="flex items-center gap-5">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-3 mb-1">
                  ...
                  <span className="px-2 py-0.5 bg-cyan-500/10 text-cyan-500 text-[8px] font-black uppercase tracking-widest rounded-full border border-cyan-500/20">Active v1.0.1</span>
                </div>
